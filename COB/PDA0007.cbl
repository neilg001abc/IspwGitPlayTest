      ...
      *****************************************************************
           ...
           PERFORM P00050-INITIALIZE THRU P00050-EXIT.

           PERFORM P00100-MAIN-PROCESS THRU P00100-EXIT.
...
RTN    P99999-ERROR.
NOT
USED       MOVE 'CICS' TO WS-PDA-ERROR-TYPE.
AS OF      MOVE 'PDA007' TO WPCE-PROGRAM-ID.
JAN        MOVE EIBRESP TO WPCE-RESPONSE-CODE.
2001       MOVE 'ERROR' TO WPCE-COMMAND.
