...
000900*      WITH A LINK TO TSUBR50
001000*
001100*      AND COPYLIBS   NEWCOPY   (HEADER)
001200*                     TCPYB50   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR50' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR50' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR50' USING PASS-ME-AROUND.
