       ...
       PROGRAM-ID.       ALJOCOB.
      ******************************************************************
      *   modofication for generate test   17/11/17                    *
      ...
      *                                                               *
      *  RUN JCL     - STORED IN PEDITER/TSO SAMPLIB (CWXTJCLC)       *
      *                                                                *
      ******************************************************************
       ...
       01  ALPHA-TO-NUM-CHECK         PIC 9        VALUE 1.
       01  SWITCHES.
...
********
********  FIELDS USED BY CALLED PROGRAM ALJOSUBC TO CALCULATE
...
*********
       ...
       0000-MAINLINE.
           DISPLAY 'DISPLAY NOT NEEDED'.
      *  INVALID MOVE ALPHA TO NUMERIC      *
      *     MOVE 'A' TO ALPHA-TO-NUM-CHECK.
      ***************************************
           PERFORM 9000-OPEN.
...
*********  RETURNED FROM ALJOSUBC, IT IS STORED IN A HOLD-TABLE.  THE
