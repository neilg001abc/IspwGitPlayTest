...
000800* THIS PROGRAM IS A TRAINING PROGRAM
      *      WITH A LINK TO TSUBR48
001100*      AND COPYLIBS   TCPYA48   (HEADER)
001200*                     TCPYB48   (LINK AREA)
001300*
000900* ======================================================
001400*  ISPW (TM)
...
002300*  ********  **********  *******
      *  12/12/17  Roland      Change for enhancement
      *  19/08/17  Roland      Edited under Topaz 18.2.2
      *  19/08/17  Roland      Edited under Topaz 18.2.1 20170710
 02400*  96/01/24  ISPW        NEW PROGRAM
      *  CHange Park lane
002500* ======================================================
...
008800     MOVE 'R' TO ACTION-FLAG.
           CALL 'TSUBR48' USING PASS-ME-AROUND.
...
013700     CALL 'TSUBR48' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR48' USING PASS-ME-AROUND.
