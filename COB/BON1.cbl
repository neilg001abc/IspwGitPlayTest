       ...
       01  WS-TABLE.
           05  WS-TABLE-ENTRY OCCURS 0 to 3000 TIMES
               Depending on WS-INDEX-MAX.
      *        INDEXED BY WS-INDEX.
      *        ASCENDING TBL-KEY
      ...
      *    INITIALIZE WS-CHAISE.
           ...
           PERFORM VARYING WS-INDEX FROM 1 BY 1
                     UNTIL WS-INDEX = 3000
              Move ' ' to WS-CHAISE-1 ( WS-INDEX )
              Move 0   to WS-CHAISE-2 ( WS-INDEX )
              Move ' ' to WS-CHAISE-3 ( WS-INDEX )
           END-PERFORM
           ...
           PERFORM VARYING WS-INDEX FROM 1 BY 1
            ...
            if WS-FIELD-3-AGE = ZERO or WS-FIELD-3-TAUX = ZERO
              ...
              DIVIDE WS-FIELD-3-MONTANT by WS-FIELD-3-AGE
                 GIVING WS-CALCUL-1
              DIVIDE WS-FIELD-3-TAILLE by WS-FIELD-3-TAUX
                 GIVING WS-CALCUL-2
              MULTIPLY WS-CALCUL-1 BY WS-CALCUL-2
                 GIVING WS-CALCUL-3
              MOVE WS-CALCUL-3 TO  WS-SCORE
