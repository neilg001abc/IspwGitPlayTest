...
000900*      WITH A LINK TO TSUBR38
001000*
001100*      AND COPYLIBS   TCPYA38   (HEADER)
001200*                     TCPYB38   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR38' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR38' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR38' USING PASS-ME-AROUND.
