...
000900*      WITH A LINK TO TSUBR43
001000*
001100*      AND COPYLIBS   TCPYA43   (HEADER)
001200*                     TCPYB43   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
002100*  this is for January 18, 2018
      *  change for history
...
008900     CALL 'TSUBR43' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR43' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR43' USING PASS-ME-AROUND.
