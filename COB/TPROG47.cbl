...
000900*      WITH A LINK TO TSUBR47
001000*
001100*      AND COPYLIBS   TCPYA47   (HEADER)
001200*                     TCPYB47   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008800     MOVE 'S' TO ACTION-FLAG.
008900     CALL 'TSUBR47' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR47' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR47' USING PASS-ME-AROUND.
