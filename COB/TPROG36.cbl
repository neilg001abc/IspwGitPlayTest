...
000900*      WITH A LINK TO TSUBR36
001000*
001100*      AND COPYLIBS   TCPYA36   (HEADER)
001200*                     TCPYB36   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR36' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR36' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR36' USING PASS-ME-AROUND.
