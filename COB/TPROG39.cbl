...
000900*      WITH A LINK TO TSUBR39
001000*
001100*      AND COPYLIBS   TCPYA39   (HEADER)
001200*                     TCPYB39   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR39' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR39' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR39' USING PASS-ME-AROUND.
