...
000900*      WITH A LINK TO TSUBR33
001000*
001100*      AND COPYLIBS   TCPYA33   (HEADER)
001200*                     TCPYB33   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR33' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR33' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR33' USING PASS-ME-AROUND.
