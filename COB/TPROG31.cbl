...
000900*      WITH A LINK TO TSUBR31
001000*      AXA demo
001100*      AND COPYLIBS   TCPYA31   (HEADER)
001200*                     TCPYB31   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR31' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR31' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR31' USING PASS-ME-AROUND.
