...
000900*      WITH A LINK TO TSUBR34
      *      demo
001000*
001100*      AND COPYLIBS   TCPYA34   (HEADER)
001200*                     TCPYB34   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR34' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR34' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR34' USING PASS-ME-AROUND.
