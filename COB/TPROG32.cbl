...
000900*      WITH A LINK TO TSUBR32
001000*
001100*      AND COPYLIBS   TCPYA32   (HEADER)
      *      Demo
001200*                     TCPYB32   (LINK AREA)
001300* ======================================================
001400*  ISPW (TM)
...
008900     CALL 'TSUBR32' USING PASS-ME-AROUND.
009000
...
013700     CALL 'TSUBR32' USING PASS-ME-AROUND.
013800
...
014400        CALL 'TSUBR32' USING PASS-ME-AROUND.
