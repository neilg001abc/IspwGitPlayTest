      ...
      *  TRAINING SESSIONS
      *
      *  Démonstration d'une difference 2
      *
      *                                                                *
      *  INPUT FILE  - EMPLOYEE WAGE INFORMATION                       *
      *              - STORED saaaIN XPEDITER/TSO SAMPLIB (
      *            CWXDATA)       *
...
*********
       2000-PROCESS-HOURLY.
           ...
           IF WA-EMP-HOURS GREATER THAN 40
               ...
               COMPUTE OT-AMOUNT = OT-HOURS * (WA-EMP-RATE * 2.5)
           ELSE
...
*********
       7000-PRINT-REGION-REPORT.
           ...
           move WA-EMP-HIRE-MM to TOTAL-FIELDS.
