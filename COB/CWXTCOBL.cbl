      ...
      *    PERFORM 1000 TIMES
           PERFORM UNTIL YRS-OF-SERVICE > 99
      ...
      ***
       7000-PRINT-REGION-REPORT.
           ...
           ADD 1 TO REGION-SUB.
           DISPLAY 'REG-LINE-COUNT ' REG-LINE-COUNT.
           DISPLAY 'REGION-SUB ' REGION-SUB.
      ***
