//TJOB48 JOB (BENCHMARK),'ISPW TRAINING',
//         CLASS=A,MSGCLASS=H,MSGLEVEL=(1,1),TIME=(0,09)
//*   my comment jcl changes
//TREXX48  EXEC PGM=IKJEFT01,DYNAMNBR=20,REGION=2048K
...
//SYSTSIN  DD *
  PROFILE MSGID
  ISPSTART  CMD(%TREXX48)
/*
//*==================================================
//* EXECUTE THE PROGRAM TPROG48 TO PRODUCE THE REPORT
//*==================================================
//PROCESS  EXEC PGM=TPROG48
