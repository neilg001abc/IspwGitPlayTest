//TJOB46 JOB (COMPUWARE),'ISPW TRAINING',
//         CLASS=A,MSGCLASS=H,MSGLEVEL=(1,1),TIME=(0,09)
//*
//TREXX46  EXEC PGM=IKJEFT01,DYNAMNBR=20,REGION=2048K
...
//SYSTSIN  DD *
  PROFILE MSGID
  ISPSTART  CMD(%TREXX46)
/*
//*==================================================
//* EXECUTE THE PROGRAM TPROG46 TO PRODUCE THE REPORT
//*==================================================
//PROCESS  EXEC PGM=TPROG46
